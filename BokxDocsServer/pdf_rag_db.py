...
def chat_completion(new_message: str):
  ...
  print(f"[VECTOR_LOG] Finished loading vectors {vectorstore._collection.count()}")
  #if len(splits)>25:
  #  print("splits are: ",len(splits))
...
def main():
  ...
  parser.add_argument('--question', type=str, default="What page talks about what happened to Case that made him be in debt?")
